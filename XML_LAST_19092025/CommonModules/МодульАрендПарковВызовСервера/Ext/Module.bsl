...
Функция РасторгнутьАрендуТранспорта(Запрос) Экспорт
	...
	Попытка
		...
		ЭлементБлокировкиДанных = БлокировкаДанных.Добавить("Документ.АрендаПарка");
		ЭлементБлокировкиДанных = БлокировкаДанных.Добавить("Справочник.Транспорт");
		...
		Если АрендованныйПарк = Справочники.Парки.ПустаяСсылка() Тогда
...
Процедура ВызватьОшибкуОтсутствуетИнформацияОАрендованномПаркеДокумента()
	...
	|Обатите внимание на дату истечения договора.");
	ВызватьИсключение Шаблон;
КонецПроцедуры
